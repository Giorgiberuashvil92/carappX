...
export default function PartsHomeScreen() {
  ...
  const renderVerticalStoreCard = (store: any) => {
    ...
    return (
      <TouchableOpacity key={store.id} style={styles.verticalStoreCard} activeOpacity={0.95}>
  ...
  const renderVerticalPartCard = (part: any) => {
    ...
    return (
      <TouchableOpacity key={part.id} style={styles.verticalPartCard} activeOpacity={0.95}>
              ...
              <View style={styles.modernSection}>
                ...
                {dismantlers.length > 0 ? (
                  <View style={styles.verticalStoresList}>
                    {dismantlers.map(renderVerticalStoreCard)}
                  </View>
                ) : (
              ...
              <View style={styles.modernSection}>
                ...
                {filteredParts.length > 0 ? (
                  <View style={styles.verticalPartsList}>
                    {filteredParts.map(renderVerticalPartCard)}
                  </View>
                ) : (
                  <View style={styles.emptyState}>
            ...
            {activeTab === 'მაღაზიები' && (
              <View style={styles.modernSection}>
                ...
                {filteredStores.length > 0 ? (
                  <View style={styles.verticalStoresList}>
                    {filteredStores.map(renderVerticalStoreCard)}
                  </View>
                ) : (
                  <View style={styles.emptyState}>
